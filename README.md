...
- Meta-optimizer: ILS variants beyond the shipped Lourenço-Martin-Stützle 2003 baseline (Improving / BetterOrEqual / RandomWalk / SimulatedAnnealing acceptance, adaptive perturbation strength, optional population of incumbents picked at random per restart). What's still missing: basin-hopping-style large-jump perturbation (the existing adaptive ramp already approximates this), and crossover between population members for genetic-style recombination.
