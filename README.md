...
- Propagation: 1-UIP / proper conflict analysis. Current implementation offers a drop-and-retry post-pass (`propagate(.., minimizeConflict = true)`) — sound but quadratic in propagation cost; a true conflict-resolution pass would be cheaper and tighter.
