...
- Perf (post-benchmark): incremental scoring audit. Whether `deltaIfBoolFlipped` / `deltaIfIntSet` are O(1) or O(arity) per call matters at million-flips-per-second. May need watched-data-structures for the slow factors.
