...
enum class Category {
    SAT, UNSAT, CSP, SCHEDULING, PACKING, ROUTING, ASSIGNMENT, OPTIMIZATION,
}
...
fun corpus(relPath: String): ProblemSource.Vendored =
    ProblemSource.Vendored("klause-bench/corpus/$relPath")
...
object Catalog {
    ...
    fun byTag(tag: String): List<ProblemRef> =
        suites.flatMap { it.problems }.filter { tag in it.tags }
}
