...
internal class LpSolution(val status: FloatLpStatus, val objectiveValue: Double, private val primalValues: DoubleArray) {
 ...
 *
 * A null from the engine is [FloatLpStatus.INDETERMINATE], not [FloatLpStatus.INFEASIBLE]: it also covers
