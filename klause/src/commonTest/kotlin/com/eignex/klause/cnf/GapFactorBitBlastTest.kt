...
class GapFactorBitBlastTest {
    ...
    @Test fun disjunctive() = feasibleSampleIsSat(
        "disjunctive",
        Problem(0, 2, arrayOf(IntDomain(0, 5), IntDomain(0, 5)), arrayOf<Factor>(
    ...
    @Test fun cumulative() = feasibleSampleIsSat(
        "cumulative",
        Problem(0, 3, arrayOf(IntDomain(0, 4), IntDomain(0, 4), IntDomain(0, 4)), arrayOf<Factor>(
            Cumulative(starts = intArrayOf(0, 1, 2), durations = intArrayOf(2, 2, 2),
                resources = intArrayOf(1, 1, 1), capacity = 2),
        )),
    )
    ...
    @Test fun count() = feasibleSampleIsSat(
        ...
        Problem(0, 4, arrayOf(IntDomain(0, 2), IntDomain(0, 2), IntDomain(0, 2), IntDomain(0, 3)), arrayOf<Factor>(
    ...
    @Test fun nvalue() = feasibleSampleIsSat(
        "nvalue",
        Problem(0, 4, arrayOf(IntDomain(0, 2), IntDomain(0, 2), IntDomain(0, 2), IntDomain(1, 3)), arrayOf<Factor>(
    ...
    @Test fun gcc() = feasibleSampleIsSat(
        "gcc",
        Problem(0, 3, arrayOf(IntDomain(0, 2), IntDomain(0, 2), IntDomain(0, 2)), arrayOf<Factor>(
            GlobalCardinality(xs = intArrayOf(0, 1, 2), cover = intArrayOf(0, 1, 2),
                countLow = intArrayOf(1, 1, 0), countHigh = intArrayOf(2, 2, 1)),
        )),
    )
    ...
    @Test fun setSubset() = feasibleSampleIsSat(
        "set subset",
        Problem(4, 0, emptyArray(), arrayOf<Factor>(
    ...
    @Test fun monotone() = feasibleSampleIsSat(
        "monotone",
        Problem(0, 3, Array(3) { IntDomain(0, 5) }, arrayOf<Factor>(
    ...
    @Test fun lexLess() = feasibleSampleIsSat(
        "lex less",
        Problem(0, 4, Array(4) { IntDomain(0, 3) }, arrayOf<Factor>(
    ...
    @Test fun valuePrecede() = feasibleSampleIsSat(
        "value precede",
        Problem(0, 3, Array(3) { IntDomain(0, 2) }, arrayOf<Factor>(
    ...
    @Test fun elementConst() = feasibleSampleIsSat(
        ...
        Problem(0, 2, arrayOf(IntDomain(1, 3), IntDomain(5, 9)), arrayOf<Factor>(
    ...
    @Test fun elementVars() = feasibleSampleIsSat(
        ...
        Problem(0, 5, arrayOf(IntDomain(0, 5), IntDomain(1, 3), IntDomain(0, 5), IntDomain(0, 5), IntDomain(0, 5)), arrayOf<Factor>(
    ...
    @Test fun inverse() = feasibleSampleIsSat(
        "inverse",
        Problem(0, 6, Array(6) { IntDomain(0, 2) }, arrayOf<Factor>(
    ...
    @Test fun sort() = feasibleSampleIsSat(
        "sort",
        Problem(0, 6, Array(6) { IntDomain(0, 3) }, arrayOf<Factor>(
    ...
    @Test fun arrayMax() = feasibleSampleIsSat(
        "array max",
        Problem(0, 4, Array(4) { IntDomain(0, 5) }, arrayOf<Factor>(
    ...
    @Test fun argMin() = feasibleSampleIsSat(
        "arg min",
        Problem(0, 4, arrayOf(IntDomain(0, 2), IntDomain(0, 5), IntDomain(0, 5), IntDomain(0, 5)), arrayOf<Factor>(
    ...
    @Test fun diffn() = feasibleSampleIsSat(
        "diffn",
        Problem(0, 4, Array(4) { IntDomain(0, 5) }, arrayOf<Factor>(
            Diffn(xs = intArrayOf(0, 1), ys = intArrayOf(2, 3), widths = intArrayOf(2, 2), heights = intArrayOf(2, 2)),
        )),
    )

    @Test fun binPacking() = feasibleSampleIsSat(
        "bin packing",
        Problem(0, 3, Array(3) { IntDomain(1, 2) }, arrayOf<Factor>(
            BinPacking(bins = intArrayOf(0, 1, 2), weights = intArrayOf(1, 1, 1),
                mode = BinPacking.Mode.UniformCapacity, uniformCapacity = 3, numBins = 2, binOffset = 1),
        )),
    )
    ...
    @Test fun knapsack() = feasibleSampleIsSat(
        ...
        Problem(0, 4, arrayOf(IntDomain(0, 1), IntDomain(0, 1), IntDomain(0, 5), IntDomain(0, 9)), arrayOf<Factor>(
    ...
    @Test fun table() = feasibleSampleIsSat(
        "table",
        Problem(0, 2, Array(2) { IntDomain(0, 2) }, arrayOf<Factor>(
    ...
    @Test fun sequence() = feasibleSampleIsSat(
        "sequence",
        Problem(0, 5, Array(5) { IntDomain(0, 1) }, arrayOf<Factor>(
    ...
    @Test fun regular() = feasibleSampleIsSat(
        ...
        Problem(0, 3, Array(3) { IntDomain(1, 2) }, arrayOf<Factor>(
            Regular(seq = intArrayOf(0, 1, 2), numStates = 2, alphabetSize = 2,
