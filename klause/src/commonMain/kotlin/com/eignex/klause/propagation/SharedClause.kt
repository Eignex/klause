 ...
 * new glue clauses to the shared pool. `null` on [com.eignex.klause.backtrack.BacktrackParams]
...
interface ClauseExchange {
     ...
     *  ([com.eignex.klause.backtrack.BacktrackParams.cancellation]) segment of a single-threaded
