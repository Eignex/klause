...
internal class LearnedClauseDb(
     ...
     *  Gates the #202 binary-resolution minimization, which is a no-op without binary clauses.
    ...
    /** Three-tier database tier per learned clause (#201), parallel to [store], stored as
