package com.eignex.klause.solver.factor.bool.internals
...
/** Compressed violation degree: `0` when satisfied, `compressViolation(distance, softCap)` otherwise. */
 ...
 * the whole factor. Shared by [com.eignex.klause.solver.factor.bool.PseudoBoolean] and `ReifiedPseudoBoolean`.
 */
...
/* ------------------------------------------------------------------ *
 *  PseudoBoolean propagation helpers
 * ------------------------------------------------------------------ */
 ...
 * [com.eignex.klause.solver.factor.bool.PseudoBoolean] directly and by `ReifiedPseudoBoolean`
 * when its aux Boolean is pinned.
