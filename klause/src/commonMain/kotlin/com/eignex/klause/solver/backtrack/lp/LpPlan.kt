...
data class LpPlan(
     ...
     * scheduling makespan. See [com.eignex.klause.solver.lp.relaxation.CumulativeRelaxation].
     */
     ...
     * verifiable upper bound on every task end. See [com.eignex.klause.solver.lp.relaxation.CumulativeRelaxation].
     */
