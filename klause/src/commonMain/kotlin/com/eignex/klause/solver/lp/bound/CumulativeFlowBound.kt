 ...
 * **preemptive** relaxation of a [com.eignex.klause.solver.factor.Cumulative] /
 * [com.eignex.klause.solver.factor.Disjunctive]: every task `i` must place its work `Eᵢ = durᵢ·resᵢ`
