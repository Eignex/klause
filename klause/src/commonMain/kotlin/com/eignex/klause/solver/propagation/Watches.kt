 ...
 * [PropagationState.boolWatchersByLit]. Called by watcher-using factors when they relocate a watch
...
/** O(1) removal of `[factorId]` from `boolWatchersByLit[lit]` via the [PropagationState.boolWatchPos]
 ...
 *  keeping the two index-aligned. The caller fixes [PropagationState.boolWatchPos] for the moved entry. */
