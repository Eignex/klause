 ...
 *
 * The magnitudes come from bound propagation over the model's own rows, started from the domains as the
...
internal fun SmtLib.Builder.digitizeWideInts(
    ...
    val needed = (0 until nextInt).filter { magnitude[it] > LONG_MAX_MAGNITUDE }
