...
internal fun Compiler.Build.assertExpr(expr: BoolExpr) {
    when (expr) {
        ...
        is com.eignex.klause.ast.AllDifferentExceptExpr -> assertExpr(decomposeAllDifferentExcept(expr))
        is com.eignex.klause.ast.ArgSortExpr -> assertExpr(decomposeArgSort(expr))
        is com.eignex.klause.ast.NetworkFlowExpr -> assertExpr(decomposeNetworkFlow(expr))
        is com.eignex.klause.ast.NetworkFlowCostExpr -> assertExpr(decomposeNetworkFlowCost(expr))
