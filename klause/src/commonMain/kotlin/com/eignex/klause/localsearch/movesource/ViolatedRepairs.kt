 ...
 * [com.eignex.klause.localsearch.Invariant.proposeRepairMoves]. The null "no candidate" contract is policy
...
class ViolatedRepairs(
    ...
    /** When true, draws each factor's opt-in [com.eignex.klause.localsearch.Invariant.proposeExtendedRepairMoves]
